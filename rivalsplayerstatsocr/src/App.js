      ...
      if (playerArr[i] !== "") {
        ...
        .then(data => {
          ...
          if (data.ok) {
            ...
            document.getElementById("playerResults").innerHTML += `<a href="https://tracker.gg/marvel-rivals/profile/ign/${arr2[i].name}/overview?season=4" target='_blank'>Detailed Summary</a>`;
